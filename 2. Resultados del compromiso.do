...
program define nexuspliego
	...
	*A) Ajustes para el fuzze merge
	...
	ren (d_region_destino d_dreugel_destino) (d_dpto d_dreugel)
...
order d_dpto pliego ejecutora d_dreugel codpliego secejec cod_ue cod_ugel  
order meta total_movimientos avance_meta, before(resultado)

hashsort d_dpto pliego ejecutora d_dreugel
...
hashsort d_dpto pliego ejecutora 
