...
export excel using "$resultados\Metas Racionalización CdD.xlsx", sheet("UGEL") sheetreplace first(variable)
...
collapse (rawsum) doc_e doc_req nom_exd_mov1_esc1 nueva_brecha bloq_plaza plazas_creacion plaza_doc movimiento*, by(d_dpto pliego ejecutora cod_pliego secejec cod_ue)

construccion_meta

save "$resultados\Metas Racionalización CdD-Ejecutora", replace
export excel using "$resultados\Metas Racionalización CdD.xlsx", sheet("Ejecutora") sheetreplace first(variable)
/*=============================== END PROGRAM ================================*/
